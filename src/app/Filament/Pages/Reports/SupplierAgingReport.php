...
class SupplierAgingReport extends Page
{
    ...
    protected static ?string $title = 'Accounts Payable Aging';
    ...
    public function getRowsProperty(): Collection
    {
        ...
        return app(AgingReportService::class)->supplierAging($company->id, $this->asOfDate);
    }
}
